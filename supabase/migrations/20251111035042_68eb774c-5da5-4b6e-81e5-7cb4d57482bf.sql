...
CREATE OR REPLACE VIEW public.vw_logimarket_performance AS
SELECT
    DATE_TRUNC('month', o.created_at) AS month_year,
    COUNT(o.id) AS total_pedidos,
    SUM(o.final_price) AS gmv_vendas_brutas, -- Gross Merchandise Volume
...
CREATE OR REPLACE VIEW public.vw_logimarket_kpis_current AS
SELECT
